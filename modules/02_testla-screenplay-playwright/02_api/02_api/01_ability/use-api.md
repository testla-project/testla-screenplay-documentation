...
The `UseAPI` class is part of a testing library built on top of Playwright, implementing the Screenplay pattern. This class provides methods to interact with an API for testing purposes.
